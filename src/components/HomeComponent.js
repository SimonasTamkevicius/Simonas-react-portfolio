      ...
      <div className="flex flex-col items-center md:flex-row md:py-10">
        ...
        <div className="w-full md:w-1/2 md:mt-0 lg:mt-0">
          ...
          <div className="pt-10 mx-auto flex justify-center">
            ...
            Welcome! I'm Simonas, a developer crafting exceptional digital experiences. Explore my portfolio and let's create something awesome together!
            </p>
          </div>
        </div>
        <div className="mx-auto flex flex-col justify-center items-center pt-5 md:pt-80 lg:pt-96">
          <Link to='about' smooth={true} offset={-65} duration={1000}>
            <Image src={imgScrollArrow} className="w-8 h-8 animate-bounce md:w-18 md:h-18 lg:w-16 lg:h-16 cursor-pointer" />
          </Link>
        </div>
      </div>
    </>
